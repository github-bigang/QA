...
# 			sentence2 = items[3].lower().split(' * ')[0]
			#kazi: reading qid from test file
			qid = items[1]
			...
			#kazi: putting qid
			instances.append((qid, label, sentence1, sentence2, label_id, word_idx_1, word_idx_2, char_matrix_idx_1, char_matrix_idx_2,
							  POS_idx_1, POS_idx_2, NER_idx_1, NER_idx_2))
		infile.close()

		# sort instances based on sentence length
		#kazi: word_idx_1, word_idx_2 have moved by 1 index, so changing the indices below from 4,5 to 5,6
		...
		for batch_index, (batch_start, batch_end) in enumerate(batch_spans):
			...
			for i in xrange(batch_start, batch_end):
				#kazi: reading qid and append it
				(qid, label, sentence1, sentence2, label_id, word_idx_1, word_idx_2, char_matrix_idx_1, char_matrix_idx_2,
			...
			#kazi: append qid_batch
			self.batches.append((qid_batch, label_batch, sent1_batch, sent2_batch, label_id_batch, word_idx_1_batch, word_idx_2_batch, 
